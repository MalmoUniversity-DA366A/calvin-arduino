...
#define ACTOR_SIZE      							1
#define FIFO_SIZE     								2     //Must be a power of two
#define NUMBER_OF_PORTS     						1
#define NUMBER_OF_SUPPORTED_ACTORS					1
...
extern	int fifoPop(fifo*);
extern	rStatus fifoAdd(fifo*, int);
